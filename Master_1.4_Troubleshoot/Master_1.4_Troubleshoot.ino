/*
  ...
  Troublehoot: Ich habe einen wichtigen Sicherheitsmechanismus vergessen --> Klappe nur schließen, wenn Klappe auch zu
...
int SensorServo = 4;                                        // Anschluss des Sensors für die Position des Motors
